...
public class Decipher {
    ...
    public static String decryptData(Map<String, String> map) throws Exception {
        ...
        // 获取自己私钥解密
        PrivateKey pvkformPfx = RSA.getPvkformPfx("D:\\pri.key","suibiana");
//        PrivateKey pvkformPfx = RSA.getPvkformPfx("F:\\miyao\\demo\\user-rsa.pfx","123456");
    ...
    public static Map<String, String> encryptData(String json) throws Exception {
        ...
        // 获取公钥
        PublicKey pubKeyFromCrt = RSA.getPubKeyFromCRT("D:\\pub.key");
